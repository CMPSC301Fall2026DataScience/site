...
::: {.callout-tip icon="true"}
## What We covered in these slides

✅ Tidyverse ecosystem  
✅ Pipe operator `%>%` (and `|>`) for readable code  
...
::: {.callout-important}
## For Next Class: Data Visualization (tools from base R, ggplot2 and plotly)

📚 **Practice:** Build coded pipelines with datasets
💻 **Experiment:** Combine verbs in creative ways to build plots from data 
🔮 **Preview:** Use the plots to see what's *going on* in the data
